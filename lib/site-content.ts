...
export const siteCopy: Record<Locale, SiteCopy> = {
  en: {
    ...
    hero: {
      ...
      titleLine1: 'Luxury Real Estate',
      titleLine2: 'with Long-Term Value',
      subtitle:
        'A refined holding brand for high-net-worth buyers, private investors, and families seeking trust, privacy, and premium execution.',
    ...
    contact: {
      ...
      submit: 'Send inquiry',
      success: 'Your inquiry has been logged locally. Hook this form to an API when ready.',
      addressLabel: 'Office',
      address: 'The Office, Tulip, 90th Street, 5th Settlement, New Cairo, Egypt',
      hotlineLabel: 'Hotline',
      hotline: '+20 15663',
      emailLabel: 'Email',
      emailValue: 'hello@goldgroup.com',
      mapCta: 'Open map',
  ...
  ar: {
    ...
    hero: {
      ...
      titleLine1: 'عقارات فاخرة',
      titleLine2: 'بقيمة طويلة الأجل',
      subtitle:
        'علامة راقية للمستثمرين والعملاء الذين يبحثون عن الثقة والخصوصية والتنفيذ عالي المستوى.',
    ...
    contact: {
      ...
      success: 'تم حفظ استفسارك محلياً. يمكنك ربط النموذج بـ API لاحقاً.',
      addressLabel: 'المكتب',
      address: 'The Office, Tulip, 90th Street, 5th Settlement, New Cairo, Egypt',
